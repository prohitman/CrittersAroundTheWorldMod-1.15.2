...
@OnlyIn(Dist.CLIENT)
public class FireFlyBumLayerRenderer<T extends LivingEntity> extends LayerRenderer<T, FireFlyModel<T>>
{
   private static final RenderType BUM_LAYER = ModRenderTypes.getBumLayer(new ResourceLocation(CrittersAroundTheWorld.MOD_ID, "textures/entity/fire_fly_bum.png"));
