...
import com.prohitman.crittersaroundtheworldmod.client.renderers.BlueWhaleRenderer;
...
public class ClientEventBusSubscriber {
	...
	public static void clientSetup(FMLClientSetupEvent event) {
		...
		RenderingRegistry.registerEntityRenderingHandler(ModEntities.BLUE_WHALE_ENTITY.get(), BlueWhaleRenderer::new);
   }
}
